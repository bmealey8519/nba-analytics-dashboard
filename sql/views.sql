-- team ppg
CREATE OR REPLACE VIEW team_ppg AS
WITH team_scores AS (
...
-- player stats (ppg)
CREATE OR REPLACE VIEW player_ppg AS
SELECT
    p.full_name,
...
CREATE OR REPLACE VIEW double_double_leaders AS
...
CREATE OR REPLACE VIEW triple_double_leaders AS
WITH game_categories AS (
    SELECT
        player_id,
		team_id,
...
CREATE OR REPLACE VIEW team_scoring_leaders AS
...
CREATE OR REPLACE VIEW change_in_performance AS
...
-- rolling ten ppg
CREATE OR REPLACE VIEW rolling_10_ppg AS
...
-- hot streaks
CREATE OR REPLACE VIEW hot_streaks AS 
